...
const LeftSideBar = () => {
  return (
    <div>
        <div>
            <div>
                <img className='w-10 h-10 text-black mt-2 mx-3'
...
<div className='flex item-center'>
    ...
    <h1 className='text-white text-xl px-3 font-semi-bold'>Notifications</h1>
</div>
...
<div className='flex item-center'>
    ...
    <h1 className='text-white text-xl px-3 font-semi-bold'>Bookmarks</h1>
</div>
...
<button className='bg-[#1098F0] px-5 py-3 border-none w-full text-white rounded-full mt-7 font-bold mb-2 mr-5'>Post</button>
